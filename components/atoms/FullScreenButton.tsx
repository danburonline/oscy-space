...
export default function BackHomeButton() {
  ...
  React.useEffect(() => {
    document.getElementById('webGL').addEventListener('fullscreenchange', () => {
  ...
  return (
    <button
      ...
      className='absolute bottom-0 right-11 z-10 flex items-center justify-center p-3 m-3 text-white transition-colors ease-in-out bg-blue-600 rounded-md cursor-pointer duration-350 hover:bg-blue-800'
    >
      {buttonText}
    </button>
  )
